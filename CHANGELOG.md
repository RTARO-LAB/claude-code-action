...
## Fork Changes (RTARO-LAB/claude-code-action@beta)
...
- **Updated Base Action**: Uses `RTARO-LAB/claude-code-base-action@beta` which includes OAuth credential handling
